...
$business->biz_holiday_operating_close_time = isset($_GET['BusinessHolidayOperatingCloseTime'])? $_GET['BusinessHolidayOperatingCloseTime'] : die();

$business->holiday_close();
...
$business_arr = array(
    ...
    'BusinessNormalOperatingCloseTime'=> $business->biz_normal_operating_start_time,
