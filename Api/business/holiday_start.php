...
$business->biz_holiday_operating_start_time = isset($_GET['BusinessHolidayOperatingStartTime'])? $_GET['BusinessHolidayOperatingStartTime'] : die();

$business->holiday_start();
